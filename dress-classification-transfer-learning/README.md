# Dress Classification with DINOv2 and ResNet18

An end-to-end deep-learning project for classifying fashion images into 10 dress categories. I built and compared two transfer-learning strategies in PyTorch:
